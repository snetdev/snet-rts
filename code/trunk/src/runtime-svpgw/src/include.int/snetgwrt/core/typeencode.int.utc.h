...
#ifndef __SVPSNETGWRT_CORE_TYPEENCODE_INT_H
#define __SVPSNETGWRT_CORE_TYPEENCODE_INT_H

#include "core/typeencode.utc.h"
...
#endif // __SVPSNETGWRT_CORE_TYPEENCODE_INT_H
