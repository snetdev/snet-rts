...
static void SNet__ts00__E(snet_handle_t *hnd)
{
  snet_record_t *rec = NULL;
  void *field_e = NULL;
  ...
  field_e = SNetRecTakeField(rec, F__ts00__e);

  SNetCall__E(hnd, field_e);
}

static snet_tl_stream_t *SNet__ts00___SL___SL(snet_tl_stream_t *in_buf)
{
...
static snet_tl_stream_t *SNet__ts00___SL___SR___SL(snet_tl_stream_t *in_buf)
{
  snet_tl_stream_t *out_buf = NULL;
  snet_typeencoding_t *out_type = NULL;
  snet_box_sign_t *out_sign = NULL;
...
static snet_tl_stream_t *SNet__ts00___SL___SR___SR___P1(snet_tl_stream_t *in_buf)
{
  snet_tl_stream_t *out_buf = NULL;
  snet_typeencoding_t *out_type = NULL;
  snet_box_sign_t *out_sign = NULL;
...
static snet_tl_stream_t *SNet__ts00___SL___SR___SR___P2(snet_tl_stream_t *in_buf)
{
  snet_tl_stream_t *out_buf = NULL;
  snet_typeencoding_t *out_type = NULL;
  snet_box_sign_t *out_sign = NULL;
...
static snet_tl_stream_t *SNet__ts00___SL___SR___SR(snet_tl_stream_t *in_buf)
{
  snet_tl_stream_t *out_buf = NULL;
              ...
              SNetTencCreateTypeEncodingList(2, 
                ...
                SNetTencTypeEncode(1, 
                  SNetTencVariantEncode(
                    ...
                    SNetTencCreateVector(0), 
                    SNetTencCreateVector(0)))), 
              &SNet__ts00___SL___SR___SR___P1, 
              &SNet__ts00___SL___SR___SR___P2);

  return (out_buf);
}

static snet_tl_stream_t *SNet__ts00___SL___SR(snet_tl_stream_t *in_buf)
{
  snet_tl_stream_t *out_buf = NULL;

  out_buf = SNetSerial(in_buf, 
              &SNet__ts00___SL___SR___SL, 
              &SNet__ts00___SL___SR___SR);
...
static snet_tl_stream_t *SNet__ts00___SL(snet_tl_stream_t *in_buf)
{
  ...
  out_buf = SNetSerial(in_buf, 
              &SNet__ts00___SL___SL, 
              &SNet__ts00___SL___SR);
...
static snet_tl_stream_t *SNet__ts00___SR(snet_tl_stream_t *in_buf)
{
  ...
  out_type = SNetTencTypeEncode(2, 
              SNetTencVariantEncode(
                ...
                SNetTencCreateVector(0)), 
              SNetTencVariantEncode(
                SNetTencCreateVector(1, F__ts00__f), 
                SNetTencCreateVector(0), 
                SNetTencCreateVector(0)));
...
int SNetMain__ts00(int argc, char* argv[])
{
  int ret = 0;
  ...
  ret = SNetInRun(argc, argv,
              snet_ts00_labels,
              SNET__ts00__NUMBER_OF_LABELS,
              snet_ts00_interfaces,
              SNET__ts00__NUMBER_OF_INTERFACES,
              SNet__ts00___ts00);
