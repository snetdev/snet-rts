...
/** <!--********************************************************************-->
 * $Id: datastorage.c 2892 2010-10-28 10:20:51Z dlp $
 *
 * @file datastorage.c
 *
...
typedef struct storage {
  ...
  lpel_thread_t *thread;        /**< Data manager thread (needed for join). */
} storage_t;
...
static void DataManagerThread( lpel_thread_t *env, void *ptr)
{
  MPI_Status status;
...
{
  storage.thread = LpelThreadCreate( DataManagerThread, NULL, false);
}
