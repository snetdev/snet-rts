...
typedef struct {
  ...
  snet_stream_t *global_in;   /**< Global input stream if in this node. */
  snet_stream_t *global_out;  /**< Global output stream if in this node. */
...
static void RoutingSetGlobalInput(snet_stream_t *stream) 
{
  pthread_mutex_lock(&r_info->mutex);
...
static void RoutingSetGlobalOutput(snet_stream_t *stream) 
{
  pthread_mutex_lock(&r_info->mutex);
...
static void UpdateITable(snet_id_t id, int node, snet_stream_t *stream) 
{
...
static void UpdateOTable(snet_id_t id, int node, int index, snet_stream_t *stream) 
{
...
/** <!--********************************************************************-->
 *
 * @fn  snet_stream_t *SNetRoutingContextUpdate(snet_routing_context_t *context, snet_stream_t* stream, int location)
 *
...
/** <!--********************************************************************-->
 *
 * @fn  snet_stream_t *SNetRoutingContextEnd(snet_routing_context_t *context, snet_stream_t* stream)
 *
