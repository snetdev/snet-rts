...
int SNetStreamTryWrite(snet_stream_desc_t *sd, void *item) { return LpelStreamTryWrite((lpel_stream_desc_t*)sd, item); }
...
int SNetStreamsetRemove(snet_streamset_t *set, snet_stream_desc_t *sd) { return LpelStreamsetRemove((lpel_streamset_t*)set, (lpel_stream_desc_t*)sd); }
