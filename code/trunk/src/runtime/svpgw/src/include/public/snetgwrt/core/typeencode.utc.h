...
#ifndef __SVPSNETGWRT_CORE_TYPEENCODE_H
#define __SVPSNETGWRT_CORE_TYPEENCODE_H
...
typedef enum {
    SNET_VARIANT_ITEM_TYPE_FIELD,
    SNET_VARIANT_ITEM_TYPE_TAG,
    SNET_VARIANT_ITEM_TYPE_BTAG
...
#endif // __SVPSNETGWRT_CORE_TYPEENCODE_H
